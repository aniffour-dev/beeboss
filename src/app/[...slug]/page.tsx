...
import { getContentBySlug, getAllSlugs } from "@/api/graphql/content";
...
import Product from "@/app/components/dynamic/contents/Product"; // Import the Product component
    ...
    case "product":
      return {
        ...
        twitter: {
          ...
          title: content.name,
          description: content.description || description,
          images: [content.images[0]?.sourceUrl || ""],
        },
        robots: {
          index: true,
          follow: true,
  ...
  switch (content.type) {
    ...
    case "product":
      schemaMarkup = {
        ...
        name: content.name,
        description: content.description,
        image: content.images[0]?.sourceUrl || "",
        offers: {
          "@type": "Offer",
          priceCurrency: "USD",
          price: content.price,
          availability: content.onSale
